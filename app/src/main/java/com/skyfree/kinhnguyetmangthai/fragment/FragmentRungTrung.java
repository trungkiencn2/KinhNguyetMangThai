...
public class FragmentRungTrung extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mTvDoDaiKiKinh.setText(mSoNgayDenNgayThuThai + " ngày, độ dài kỳ kinh trung bình");
        mTvDoDaiChuKy.setText(mChuKyKinhNguyet + " ngày, độ dài chu kì trung bình");
