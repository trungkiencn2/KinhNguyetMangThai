...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.normal))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.sad))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.sleepy))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.stress))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.boring))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.dizzy))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.rough))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.allergy))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.in_love))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.jealous))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.disappointment))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.monocotyledon))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.forgetful))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.miserable))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.panic))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.not_safe))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.exhausted))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.worry))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.hard_to_understand))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.heartless))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.incredulous))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.naughty))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.weak))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.bad))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.hasty))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.satisfy))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.attenuate))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.good))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.proud))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.confident))){
...
//                    if (!Utils.checkStringExist(mListMood, getString(R.string.angry))){
